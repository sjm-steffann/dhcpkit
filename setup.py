...
setup(
    ...
    entry_points={
        ...
        'dhcpkit.ipv6.options': [
            ...
            '21 = dhcpkit.ipv6.extensions.sip_servers.options:SIPServersDomainNameListOption',
            '22 = dhcpkit.ipv6.extensions.sip_servers.options:SIPServersAddressListOption',
            '23 = dhcpkit.ipv6.extensions.dns.options:RecursiveNameServersOption',
            '24 = dhcpkit.ipv6.extensions.dns.options:DomainSearchListOption',
            '25 = dhcpkit.ipv6.extensions.prefix_delegation.options:IAPDOption',
            '26 = dhcpkit.ipv6.extensions.prefix_delegation.options:IAPrefixOption',
            '31 = dhcpkit.ipv6.extensions.sntp_servers.options:SNTPServersOption',
            '37 = dhcpkit.ipv6.extensions.remote_id.options:RemoteIdOption',
            '56 = dhcpkit.ipv6.extensions.ntp.options:NTPServersOption',
            '82 = dhcpkit.ipv6.extensions.sol_max_rt.options:SolMaxRTOption',
            '83 = dhcpkit.ipv6.extensions.sol_max_rt.options:InfMaxRTOption',
        ],
        'dhcpkit.ipv6.server_extensions': [
            'listen-unicast     = dhcpkit.ipv6.server.listeners.gua',
            'listen-interface   = dhcpkit.ipv6.server.listeners.multicast_interface',

            'preference         = dhcpkit.ipv6.option_handlers.preference',
            'server-unicast     = dhcpkit.ipv6.option_handlers.server_unicast',

            'dns                = dhcpkit.ipv6.extensions.dns',
            'ntp-servers        = dhcpkit.ipv6.extensions.ntp',
            'remote-id          = dhcpkit.ipv6.extensions.remote_id',
            # 'sip-servers        = dhcpkit.ipv6.extensions.sip_servers',
            # 'sntp-servers       = dhcpkit.ipv6.extensions.sntp_servers',
            # 'sol-max-rt         = dhcpkit.ipv6.extensions.sol_max_rt',
            'static-assignments = dhcpkit.ipv6.extensions.static_assignments',
            'timing-limits      = dhcpkit.ipv6.extensions.timing_limits',
        ],
    },
    setup_requires=[
        'sphinx',
