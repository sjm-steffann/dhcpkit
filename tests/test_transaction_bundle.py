...
class TransactionBundleTestCase(unittest.TestCase):
    def setUp(self):
        self.bundle = TransactionBundle(fixtures.relayed_solicit_message, True)
    ...
    def test_request(self):
        self.assertEqual(self.bundle.request, fixtures.solicit_message)
    ...
    def test_outgoing_message(self):
        ...
        self.bundle.response = fixtures.advertise_message
        self.bundle.create_outgoing_relay_messages()
        for option_handler in self.option_handlers:
            option_handler.handle(self.bundle)

        self.assertEqual(self.bundle.outgoing_message, fixtures.relayed_advertise_message)

    def test_direct_outgoing_message(self):
        self.ia_bundle.response = fixtures.advertise_message
        self.assertEqual(self.ia_bundle.outgoing_message, fixtures.advertise_message)
